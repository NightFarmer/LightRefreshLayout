 ...
 * </p>
 */
public class LightRefreshLayout extends ViewGroup implements NestedScrollingParent,
     ...
     * @param context
     */
    public LightRefreshLayout(Context context) {
        this(context, null);
    }
     ...
     * @param attrs
     */
    public LightRefreshLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private LightRefreshHeadProvider.HeadViewHolder mHeadViewHolder;
    ...
    public void setHeadViewProvider(LightRefreshHeadProvider headViewProvider) {
